...
public class ListEx5 {
    public static void main(String[] args) {
        ...
        System.out.println("LinkdeList : " + add1(linkedList));
        System.out.println();
        System.out.println(" === 중간에 추가하기 ===");
        System.out.println("ArrayList : " + add2(arrayList));
        System.out.println("LinkdeList : " + add2(linkedList));
        System.out.println();
        System.out.println(" === 중간에 삭제하기 ===");
        System.out.println("ArrayList : " + remove2(arrayList));
        System.out.println("LinkdeList : " + remove2(linkedList));
        System.out.println();
        System.out.println(" === 순차적으로 삭제하기 ===");
        System.out.println("ArrayList : " + remove1(arrayList));
        System.out.println("LinkdeList : " + remove1(linkedList));
        System.out.println();
    }
